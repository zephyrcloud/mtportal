	...
	<body>
		...
		<div id="pagecontents">
			<div class="wrapper" >
				<div id="post">
				<div id="postitle">
								<div class="floatleft"><h1>Summary Billings </h1></div>
					...
					<div id="postcontent">
						...
						<?php
							$i=0;
							$table = "";
							$select_customers_query = 'SELECT `id`, `name` FROM `customer` WHERE id = '.$_SESSION['id'];
							...
							while ($line = mysql_fetch_array($select_customers_result, MYSQL_ASSOC)) {
								...
								while ($line1 = mysql_fetch_array($select_customers_result1, MYSQL_ASSOC)) {
									if($line1['minutesIn'] != ""){
										$table .= "<tr><td> <a href='NumbersReportAdmin.php?customer=".$line['id']."&case=".$line1['message']."&date=".$line1['dateIn']."&u=0'>" . $line1['dateIn'] . " </a></td><td>" . $line1['minutesIn'] . "</td><td> " . $line1['message'] . " </td></tr>";
										$status[$i] = $line['id'];
										$i++;
									}
								}
