<?php
	...
	?>
		...
		<form id="emailsFrm" name="emailsFrm" method="POST" action="adminUsers.php">
			...
			<table style="width: 100%; border: 1px solid; border-collapse: collapse;">
				...
				<?php 
					...
					$select_emails_query = 'SELECT email1, email2, email3 FROM user WHERE id = ' . $_GET["id"];					
					$select_emails_result = mysql_query($select_emails_query) ;
