		...
		<div id="pagecontents">
			...
			<div class="wrapper" >
				...
				<div id="post">
					...
					<div id="menu_list">
					Choose a option:
						<select id="option_menu" name="option_menu" onclick="menu_list()" >
						 <option value="0">Select a option</option>
						 <option value="1">Filter elements</option>
						 <option value="2">Order elements</option>						 
						</select>
					...
					Filter by:
						<select id="opciones" name="opciones" onclick="apply()" >
						 ...
						 <option value="6">Report History </option>
						</select>
					...
					<form method="POST" action="reports.php">
						Order by:
							<select id="order_option" name="order_option" onclick="find_id_order()"  >
							 <option value="0">Select a option</option>
							 <option value="1">User</option>
							 <option value="2">Action type</option>
							 <option value="3">Table modified</option>
							 <option value="4">Result</option>
							 <option value="5">TimeStamp ASC</option>
							 <option value="6">TimeStamp DES</option>
							</select>
								<input id="id_order" name="id_order" type="text" hidden >
					...
					Filter by parameter:
						...
						<input  id="end_report" type="submit" value="Close report" />
						<?php 
						...
						<br>						
						<form method="POST" action="reports.php">
						<input id="rep_history" name="rep_history" type="text" size="4" style="display:none;" value="1">						
						<input  id="report_history" type="submit" value="Report History" />
						</form>
					...
					<div id="postcontent" class="col-md-6">
					...
					<!--	<div class="col-md-3">
						...
						<table>
							...
							<col width="20px">
							<tr>
								<th style="border: 1px solid;">appname</th>
								<th style="border: 1px solid;">name</th>
								<th style="border: 1px solid;">Init Time</th>
							...
							$select_customers_query = "SELECT a.name as appname , CONCAT(u.firstName,' ',u.lastName) as name , au.initDate as begin, au.endDate as end 
														   FROM appuser au, app a, user u 
														   WHERE au.app = a.id AND au.user = u.id";
								$select_customers_result = mysql_query($select_customers_query) or die('Consulta fallida: ' . mysql_error());
								...
								while ($line = mysql_fetch_array($select_customers_result, MYSQL_ASSOC)) {
									...
									echo "<td style='border: 1px solid;'><span id='spanName'>" . $line['appname'] . "</span></td>";
									echo "<td style='border: 1px solid;'><span id='spanUserName'>" . $line['name'] . "</span></td>";
									echo "<td style='border: 1px solid;'><span id='spanPassword'>" . $line['begin'] . "</span></td>";
									echo "<td style='border: 1px solid;'><span id='spanPassword'>" . $line['end'] . "</span></td>";									
				...
				<!--	<div id="postcontent_user" class="col-md-6">
